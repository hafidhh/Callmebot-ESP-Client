...
Callmebot_ESP_Client Callmebot;
 ...
 * @return String
 */
String Callmebot_ESP_Client::errorToString(int error)
{
    switch(error) {
 ...
 * @param url 
 */
void Callmebot_ESP_Client::callmebothttps(String url)
{
 ...
 * 
 */
void Callmebot_ESP_Client::clock()
{
 ...
 * 
 */
void Callmebot_ESP_Client::begin()
{
	Callmebot.clock();
}
 ...
 */
void Callmebot_ESP_Client::whatsappMessage(String phoneNumber, String apiKey, String message)
{
 ...
 * @param message "textmessage".
 */
void Callmebot_ESP_Client::facebookMessage(String apiKey, String message)
{
 ...
 * @param message "textmessage".
 */
void Callmebot_ESP_Client::telegramMessage(String username, String message)
{
...
/**
 * CallMeBot Facebook Messages Image.
 * @param apiKey "apiKey", to get apiKey : https://www.callmebot.com/blog/free-api-facebook-messenger/.
 * @param imglink "image link".
 */
void Callmebot_ESP_Client::facebookMessageImg(String apiKey, String imglink)
{
	String url = "/facebook/send.php?apikey=" + apiKey + "&image=" + urlEncode(imglink);
 ...
 */
void Callmebot_ESP_Client::telegramGroup(String apiKey, String message, bool html_format)
{
	String html = "no";
 ...
 */
void Callmebot_ESP_Client::telegramCall(String username, String message, String language, unsigned long repeat, String textcarbon, unsigned long timeout)
{
 ...
 */
void Callmebot_ESP_Client::telegramCallMp3(String username, String mp3link)
{
 ...
 * @return httpResponse
 */
String Callmebot_ESP_Client::debug()
{
	String Response;
